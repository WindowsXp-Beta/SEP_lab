...
public:
  ...
  TreeNode(int x,int y,TreeNode *l=NULL,TreeNode *r=NULL);
  void setBoldNum(int b){
      boldNum=b;
  }
};
...
public:
  ...
  void Pos_Search(TreeNode *cur,TreeNode *t);
  void recur_search(TreeNode *cur,TreeNode *test, long long int &min_distance, TreeNode*& guess);
};
